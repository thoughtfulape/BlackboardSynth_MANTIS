...
##PmodA                                                                                                        
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { sine[0] }]; #IO_L6P_T0_35 Sch=JA1_P   
set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { sine[1] }]; #IO_L6N_T0_VREF_35 Sch=JA1_N
set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS33 } [get_ports { sine[2] }]; #IO_L18P_T2_AD13P_35 Sch=JA2_P
set_property -dict { PACKAGE_PIN G20   IOSTANDARD LVCMOS33 } [get_ports { sine[3] }]; #IO_L18N_T2_AD13N_35 Sch=JA2_N
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { sine[4] }]; #IO_L5P_T0_AD9P_35 Sch=JA3_P
set_property -dict { PACKAGE_PIN E19   IOSTANDARD LVCMOS33 } [get_ports { sine[5] }]; #IO_L5N_T0_AD9N_35 Sch=JA3_N
set_property -dict { PACKAGE_PIN E17   IOSTANDARD LVCMOS33 } [get_ports { sine[6] }]; #IO_L3P_T0_DQS_AD1P_35 Sch=JA4_P
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { sine[7] }]; #IO_L3N_T0_DQS_AD1N_35 Sch=JA4_N
