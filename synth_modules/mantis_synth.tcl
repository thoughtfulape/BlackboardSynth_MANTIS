...
################################################################
# This is a generated script based on design: mantis_synth
#
...
# source mantis_synth_script.tcl
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:mantis_synth:1.0\
...
proc create_root_design { parentCell } {
  ...
  set wav_A [ create_bd_port -dir O -from 7 -to 0 wav_A ]
  set wav_B [ create_bd_port -dir O -from 7 -to 0 wav_B ]

  # Create instance: mantis_synth_0, and set properties
  set mantis_synth_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:mantis_synth:1.0 mantis_synth_0 ]

  # Create instance: mantis_synth_1, and set properties
  set mantis_synth_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:mantis_synth:1.0 mantis_synth_1 ]
...
Flash#Quad SPI Flash#GPIO#Quad SPI Flash#GPIO#SPI 1#SPI 1#SPI 1#SPI 1#UART\
0#UART 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#USB 0#USB\
0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD\
0#SD 0#SD 0#USB Reset#SD 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO}\
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins mantis_synth_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins mantis_synth_1/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net clk_0_1 [get_bd_ports clk] [get_bd_pins mantis_synth_0/clk] [get_bd_pins mantis_synth_1/clk]
  connect_bd_net -net mantis_synth_0_wav [get_bd_ports wav_A] [get_bd_pins mantis_synth_0/wav]
  connect_bd_net -net mantis_synth_1_wav [get_bd_ports wav_B] [get_bd_pins mantis_synth_1/wav]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins mantis_synth_0/s_axi_aclk] [get_bd_pins mantis_synth_1/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins mantis_synth_0/s_axi_aresetn] [get_bd_pins mantis_synth_1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x4BB00000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mantis_synth_0/S_AXI/S_AXI_reg] -force
  assign_bd_address -offset 0x4BB01000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mantis_synth_1/S_AXI/S_AXI_reg] -force
