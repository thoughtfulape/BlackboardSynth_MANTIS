...
HD_PWD='D:/Libraries/Documents/School/MANTY/BlackboardSynth_MANTIS/synth_modules/programmable_synth_core/programmable_synth_core.runs/mantis_synth_mantis_synth_1_0_synth_1'
cd "$HD_PWD"
