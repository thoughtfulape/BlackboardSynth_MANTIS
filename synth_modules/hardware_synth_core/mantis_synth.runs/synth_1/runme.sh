...
HD_PWD='D:/Libraries/Documents/School/MANTY/BlackboardSynth_MANTIS/synth_modules/proj_files/mantis_synth.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log synth_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source synth_wrapper.tcl
